...
public abstract class AbstractInput implements Input
{
   ...
   public void addInputListener(InputListener p_listener)
   {
      ...
      if (s_log.isLoggable(Level.FINER)) s_log.entering(s_className, "addInputListener");
      ...
      if (s_log.isLoggable(Level.FINER)) s_log.exiting(s_className, "addInputListener");
   }
   ...
   public void removeInputListener(InputListener p_listener)
   {
      ...
      if (s_log.isLoggable(Level.FINER)) s_log.exiting(s_className, "removeInputListener");
   }
   ...
   {
      if (s_log.isLoggable(Level.FINER)) s_log.entering(s_className, "getInputListeners");
      ...
      if (s_log.isLoggable(Level.FINER)) s_log.exiting(s_className, "getInputListeners");
