...
public class PidController implements IPidController {
	...
	public PidController(IPidInput source, IPidOutput output, String pidControllerName) {
		...
		p_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".p", 0.0);
		i_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".i", 0.0);
		d_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".d", 0.0);
		errorIncrement_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".errorIncrement", 0.0);
		errorEpsilon_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".errorEpsilon", 0.0);
		staticEpsilon_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".staticEpsilon", 0.0);
		maxIntegral_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".maxIntegral", 0.0);
		integralErrorThresh_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".integralErrorThresh", 0.0);
		differentiatorBandLimit_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".differentiatorBandLimit", 0.0);
		maxOutput_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".maxOutput", 0.0);
		minOutput_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".minOutput", 0.0);
		maxInput_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".maxInput", 0.0);
		minInput_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".minInput", 0.0);
		minOnTargetTime_config = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + "." + pidControllerName + ".minOnTargetTime", 0.0);
